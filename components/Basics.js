...
<div className='flex flex-col p-20 gap-10 lg:flex-row'>
    ...
    <div>
        <img className='w-3/4 transition hover:scale-110 cursor-pointer' src='bitcoin1.png'/>
    ...
    <div>
        <img className='w-3/4 transition hover:scale-110 cursor-pointer' src='defi.png'/>
        <span>BEGINNERS GUIDE</span>
     ...
     <div className='flex flex-col gap-10 lg:flex-row  pl-20'>
       ...
       <div>
        <img className='w-64 h-80 transition hover:scale-110 cursor-pointer' src='ethereum.png'/>
        <span>BEGINNERS GUIDE</span>
        <p className='font-bold text-xl'>What is Ethereum</p>
       </div>

       <div>
        <img className='w-64 h-80 transition hover:scale-110 cursor-pointer' src='defi1.png'/>
        <span>Key Term</span>
        <p className='font-bold text-xl'>What is DeFi</p>
       </div>

       <div>
        <img className='w-64 h-80 transition hover:scale-110 cursor-pointer' src='tax.png'/>
        <span>Tax Guilde</span>
        <p className='font-bold text-xl'>Understanding your 2021<br/> crypto taxes</p>
       </div>

       <div>
        <img className='w-64 h-80 transition hover:scale-110 cursor-pointer' src='fud.png'/>
        <span>Glossary</span>
