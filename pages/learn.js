...
function learn() {
  return (
    <div>
      ...
      <div className='flex p-10 flex-col justify-center pt-10 gap-9 items-center'>
        <h1 className='font-bold text-5xl text-blue-500'>Crypto questions,answered</h1>
      ...
      <div className='flex flex-col lg:flex-row gap-10 p-10 pt-20'>
        ...
        <div className='flex flex-col gap-5'>
            ...
            <img className='w-auto' src='eth1.png'/>
