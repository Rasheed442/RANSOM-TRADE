    ...
    <div>
      ...
      <div className='flex flex-col lg:flex-row shadow-2xl p-20 gap-20'>
         <Image
          height={400}
          width={400}
          className=' w-full lg:w-9/12' src='/crypto.jpg'/>
...
<div className='grid grid-cols-2 pl-10 lg:grid-cols-4 lg:pl-20 shadow-2xl'>

<div className=''>
    <Image
     height={200}
     width={200}
    className='border rounded-full shadow-2xl' src='/team1.jpeg'/>
     <div>
        <p>Brian Armstrong</p>
...
<div className=''>
    <Image
     height={200}
     width={200}
    className='border rounded-full shadow-2xl' src='/team2.jpeg'/>
     <div>
        <p>Emilie Choil</p>
        <p>President & Chief</p>
...
<div className=''>
    <Image
     height={200}
     width={200}
    className='border rounded-full shadow-2xl' src='/team3.jpeg'/>
     <div>
...
<div className=''>
    <Image
     height={200}
     width={200}
    className='border rounded-full shadow-2xl' src='/team4.jpeg'/>
     <div>
        <p>Alesia Haas</p>
...
<div className=''>
    <Image
     height={200}
     width={200}
    className='border rounded-full shadow-2xl' src='/team5.png'/>
     <div>
        <p>L.J. Brock</p>
...
<div className=''>
    <Image
     height={200}
     width={200}
    className='border rounded-full shadow-2xl' src='/team6.jpeg'/>
     <div>
        <p>Paul Grewal</p>
...
<div className=''>
    <Image
     height={200}
     width={200}
    className='border rounded-full shadow-2xl' src='/team7.jpeg'/>
     <div>
        <p>Manish Gupta</p>
